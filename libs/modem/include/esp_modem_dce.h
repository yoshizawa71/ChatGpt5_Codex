 ...
 *
 */
#define MODEM_COMMAND_TIMEOUT_DEFAULT (10000)      /*!< Default timeout value for most commands */
...
#define MODEM_COMMAND_TIMEOUT_RESET (3000)    /*!< Timeout value for modem reset */
...
struct modem_dce {
    ...
    //############
    esp_err_t (*modem_reset)(modem_dce_t *dce);                          /*!< Normal modem reset */
    //############
