...
typedef struct {
    ...
    int32_t devicePioDataReady;  /**< The PIO of the GNSS device that is to
                                      ...
                                      This is the PIO, _NOT_ the pin number,
                                      they are different; the PIO can usually
                                      be found in the data sheet for the GNSS
                                      device. IMPORTANT: this PIO must not already
                                      be in use for some other peripheral function
                                      within the GNSS device; should that be the
                                      case the error #U_GNSS_ERROR_PIO_IN_USE will
                                      be returned. */
    /* Add any new version 0 structure items to the end here.
     *
     * IMPORTANT IMPORTANT IMPORTANT IMPORTANT IMPORTANT IMPORTANT:
