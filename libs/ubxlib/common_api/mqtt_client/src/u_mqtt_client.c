...
// Adicionar print antes da desconexão
        printf("Antes da desconexão: totalMessagesSent=%ld, totalMessagesReceived=%ld\n",
               pContext->totalMessagesSent, pContext->totalMessagesReceived);
        ...
        // Adicionar print depois da desconexão
        printf("Depois da desconexão: totalMessagesSent=%ld, totalMessagesReceived=%ld, errorCode=%ld\n",
               pContext->totalMessagesSent, pContext->totalMessagesReceived, errorCode);
